...
public interface Linda {
    ...
    public enum eventTiming { IMMEDIATE, FUTURE }; // IMMEDIATE: Look at the current tuple

    /** TAKE/READ Asynchrone: Registers a callback which will be called when a tuple matching the template appears.
